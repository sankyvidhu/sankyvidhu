...
```mermaid
flowchart TB
    A[Business outcome and policy] --> B[Agent orchestration]
    B --> C[Context, retrieval and memory]
    B --> D[Models, tools and APIs]
    C --> E[Evaluation and observability]
    D --> E
    E --> F[Human oversight and governance]
    F --> G[Secure CI/CS/CD and operations]
```
